                ...
                <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="font-medium text-blue-900">Numbers have not been drawn yet</p>
                                <p class="text-sm text-blue-700">The board is locked but row and column numbers still need to be assigned.</p>
                            </div>
                        </div>
                        <form method="POST" action="{{ route('manage.boards.generate-numbers', $board) }}" onsubmit="return confirm('Are you sure you want to draw numbers? This will randomly assign numbers 0-9 to rows and columns.');">
                            @csrf
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 transition-colors">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
